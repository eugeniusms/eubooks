...
const About = () => {
    return (
        ...
        <div className="py-3 px-5 text-gray-700 bg-gray-50 border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            ...
            {/* Menampilkan tulisan judul */}
            <p className="text-center text-4xl text-white font-bold">About Eubooks</p>
            <p className="text-center text-2xl text-slate-400">Made with love by Eugenius Mario.</p>

            <br/>

            {/* Menampilkan gambar eubooks.jpg */}
            <div className="flex justify-center">
            <Image src="/eubooks.jpg" className="block opacity-30 hover:ease-in duration-300 hover:opacity-50" width={900} height={450}/>
            </div>

            {/* Menampilkan tombol help me... untuk mailto dan back untuk kembali ke landing page */}
            <div className="flex justify-center">
